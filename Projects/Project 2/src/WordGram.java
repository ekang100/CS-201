...
public class WordGram {
	...
	*/
	...
	public WordGram shiftAdd(String last) {
		...
		WordGram shiftNew = new WordGram(myWords, 0, myWords.length);
		for (int i = 1; i < myWords.length; i++) {
			shiftNew.myWords[i - 1] = this.myWords[i];
		}
		shiftNew.myWords[shiftNew.length() - 1] = last;
		return shiftNew;
	}
